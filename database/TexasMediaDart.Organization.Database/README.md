...
```bash
sqlpackage /Action:Publish /SourceFile:bin/Debug/TexasMediaDart.Organization.Database.dacpac /TargetServerName:localhost /TargetDatabaseName:TexasMediaDart.Organization.Database
```
